        ...
        <Suspense>
            {(() => {
                switch (kcContext.pageId) {
                    ...
                    case "my-extra-page-1.ftl": return <MyExtraPage1 {...{ kcContext, i18n, Template }} doUseDefaultCss={false} />;
                    case "my-extra-page-2.ftl": return <MyExtraPage2 {...{ kcContext, i18n, Template }} doUseDefaultCss={false} />;
                    ...
                    default: return <Fallback {...{ kcContext, i18n }} Template={Template} doUseDefaultCss={false} />;
                }
            })()}
        </Suspense>
    );
