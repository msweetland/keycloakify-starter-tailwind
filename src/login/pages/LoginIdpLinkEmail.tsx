  ...
  return (
    <Template {...{kcContext, i18n, doUseDefaultCss, classes}} headerNode={<></>}>
      ...
      <div className="prose dark:prose-invert pb-4">
        ...
        <p
          className="prose-gray px-4">{msgStr("emailLinkIdp1", idpAlias, brokerContext.username, realm.displayName)}</p>
      </div>

      <div className="flex flex-col space-y-4">
        <div
          className="bg-yellow-100 border border-yellow-200 text-sm text-yellow-800 rounded-lg p-4 dark:bg-yellow-800/10 dark:border-yellow-900 dark:text-yellow-500"
          role="alert">
        ...
        <div
          ...
          <div className="flex flex-col space-y-2">
            ...
            <a
              className="not-prose gap-x-1 text-sm decoration-2 hover:text-gray-500 font-medium hover:underline dark:text-neutral-200 dark:hover:text-neutral-400 flex items-center"
              href={url.loginAction}
            >
